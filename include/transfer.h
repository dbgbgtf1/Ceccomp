...
#define LOW_ARG0 "$low_arg[0]"
#define LOW_ARG1 "$low_arg[1]"
#define LOW_ARG2 "$low_arg[2]"
#define LOW_ARG3 "$low_arg[3]"
#define LOW_ARG4 "$low_arg[4]"
#define LOW_ARG5 "$low_arg[5]"
#define HIGH_ARG0 "$high_arg[0]"
#define HIGH_ARG1 "$high_arg[1]"
#define HIGH_ARG2 "$high_arg[2]"
#define HIGH_ARG3 "$high_arg[3]"
#define HIGH_ARG4 "$high_arg[4]"
#define HIGH_ARG5 "$high_arg[5]"
