...
load_filter (uint32_t t_arch)
{
  ...
  char f[]
      = "\x20\x00\x00\x00\x04\x00\x00\x00\x15\x00\x00\x08\x3e\x00\x00\xc0\x20"
        "\x00\x00\x00\x00\x00\x00\x00\x35\x00\x06\x00\x00\x00\x00\x40\x15\x00"
        "\x04\x00\x01\x00\x00\x00\x15\x00\x03\x00\x03\x00\x00\x00\x15\x00\x02"
        "\x00\x20\x00\x00\x00\x15\x00\x01\x00\x3c\x00\x00\x00";
