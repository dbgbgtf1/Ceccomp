...
A valid _TEXT_ format is described in EBNF-like declaration documented here:
...
Label declaration is an identifier at the beginning of line and postfixed
...
hexadecimal numbers prefixed by `0x` and normal decimal numbers.
